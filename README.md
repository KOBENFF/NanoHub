		...
		while wait(10) do
			pcall(function()
				...
				if ris_text ~= '' then
					...
					game:GetService("CoreGui")["Attack Hub"].Text4.Fragments.Text  = ris_text
				end
				local ris_text = ''
				if RGB_H then
					ris_text = 'RGB Aura'
				...
				game:GetService("CoreGui")["Attack Hub"].Text5.Fragments.Text = ris_text
				wait(300)
			end)
		end
	end)
...
function library:CreateWindow(options, ...)
	...
	main.Size = UDim2.fromOffset(545, 355)
